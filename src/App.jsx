  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 12 }}>
        {!loggedRole ? (
          <>
            <button onClick={() => go("signup")} style={btnPrimary()}>
              Signup
            </button>
            <button onClick={() => go("login")} style={btnOutline()}>
              Login
            </button>
          </>
        ) : (
          <button onClick={() => go("landing")} style={btnOutline()}>
            Exit prototype view
          </button>
        )}
      </div>
...
function BackArrow({ onClick }) {
  return (
    <div
      onClick={onClick}
      style={{ cursor: "pointer", padding: "20px 40px 0" }}
    >
...
const DOCTORS = [
  {
    ...
    certifications: [
      { name: "Advanced Obstetric Care", issuer: "EOG", year: 2019 },
    ],
  ...
  },
  {
    ...
    experienceYears: 8,
    clinicLocation: ["Zamalek Clinic, Building 2"],
    consultationFee: 250,
    conditionsTreated: ["Acne", "Eczema", "Skin Allergies"],
    subSpecialty: ["Cosmetic Dermatology"],
    education: [
      { degree: "MBBS", university: "Alexandria University", year: 2014 },
    ],
...
const PATIENT_PROFILE = {
  ...
  location: "Cairo",
  phone: "01122555884",
  nationalId: "29501150123456",
  emergencyPhone: "011225558558",
  bloodType: "O+",
...
const CHATS = [
  {
    name: "Dr. Ahmed Mohamed",
    last: "It's been great, thanks",
    unread: 0,
    img: DOCTORS[1].img,
  },
  {
    name: "Dr. Sara Mohamed",
    last: "See you at your appointment",
    unread: 2,
    img: DOCTORS[0].img,
  },
  {
    name: "Dr. Mona Khalil",
    last: "Please send your latest test results",
    unread: 0,
    img: DOCTORS[2].img,
  },
];
...
const DOCTOR_REGISTRATIONS = [
  {
    ...
    specialty: "Orthopedic",
    date: "20/5/2025",
    docs: ["Graduation Certificate", "Syndicate Card", "National ID"],
  },
  {
    name: "Dr. Laila Nour",
    ...
    <div>
      ...
      >
        <div style={{ maxWidth: 560 }}>
          ...
          >
            <span style={{ color: COLORS.red }}>Have an emergency?</span> Search
            by national ID number to find out the patient's record{" "}
            <span style={{ color: COLORS.red }}>OR</span> Find the nearest
            hospital with an ambulance
          </h1>
          <div style={{ display: "flex", gap: 16, marginTop: 32 }}>
            <button
              onClick={() => go("idSearchPublic")}
      ...
      <div style={{ padding: "40px" }}>
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => go("doctorList")}
              style={{ ...btnPrimary(), padding: "0 28px" }}
            >
              Search
            </button>
          </div>
      ...
      <div style={{ padding: "0 40px 50px" }}>
        ...
        >
          ...
          <span
            onClick={() => go("doctorList")}
            style={{ color: COLORS.main, cursor: "pointer", fontSize: 14 }}
          >
            See All
          </span>
        </div>
        <div style={{ display: "flex", gap: 10, marginBottom: 24 }}>
          {SPECIALTIES.map((s, i) => (
            <button
              ...
              style={
                i === 0
                  ? btnPrimary({ borderRadius: 10 })
                  : btnOutline({ borderRadius: 10 })
              }
            >
              {s}
            </button>
        ...
        >
          {DOCTORS.map((d) => (
            <div
              key={d.id}
              onClick={() => go("doctorProfilePublic", d)}
              style={{
                cursor: "pointer",
                border: "1px solid #eee",
                borderRadius: 14,
      ...
      <div>
        ...
        <div style={{ textAlign: "center", padding: "60px 40px" }}>
          <h2 style={{ fontSize: 28, fontWeight: 700, marginBottom: 30 }}>
            Search by ID card for your medical history
          </h2>
          <div
            style={{
              display: "flex",
            ...
            {[...Array(14)].map((_, i) => (
              <input
                ...
                style={{
                  ...
                  textAlign: "center",
                  border: "none",
                  borderBottom: `3px solid ${i < 2 ? COLORS.main : "#ddd"}`,
                  fontSize: 18,
                }}
          ...
          <button
            onClick={() => setStep(1)}
            style={{ ...btnPrimary(), padding: "16px 60px", fontSize: 18 }}
          >
            Search
          </button>
        </div>
      ...
      <div style={{ padding: "20px 40px" }}>
        ...
        >
          <div style={{ width: 260, height: 260 }}>
            <img
              src={PATIENT_PROFILE.photo}
              alt="patient"
              style={{ width: "100%", height: "100%", objectFit: "cover" }}
            />
          </div>
          <div style={{ padding: "32px 40px", color: "#fff", flex: 1 }}>
            <h3 style={{ fontSize: 26, fontWeight: 700, marginBottom: 20 }}>
              {PATIENT_PROFILE.name}
            </h3>
            <div style={{ fontSize: 16, marginBottom: 8 }}>
              Blood Type : <strong>{PATIENT_PROFILE.bloodType}</strong>
            </div>
            <div style={{ fontSize: 16, marginBottom: 8 }}>
              Chronic Diseases : {PATIENT_PROFILE.chronic}
            </div>
            <div style={{ fontSize: 16, marginBottom: 8 }}>
              Allergies : {PATIENT_PROFILE.allergies}
            </div>
            <div style={{ fontSize: 16, marginBottom: 8 }}>
              First emergency number : {PATIENT_PROFILE.emergencyPhone}
            </div>
            <div style={{ fontSize: 16, marginBottom: 20 }}>
              My Phone number : {PATIENT_PROFILE.phone}
            </div>
        ...
        >
          This is emergency-only information. The patient's full medical history
          is never shown here, by design.
        </p>
      </div>
    </div>
  );
        ...
        {filtered.map((d) => (
          ...
          >
            <div>
              ...
              <div style={{ color: COLORS.gray, marginBottom: 8 }}>
                {d.specialty}
              </div>
              <div style={{ color: "#f5b400", marginBottom: 10 }}>
              ...
              >
                <Clock size={16} />
                Waiting Time : {d.waiting} Minutes
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                Available Today From 2:00 PM
              </div>
              <br />
              <button
                onClick={() => go("doctorProfilePublic", d)}
                style={{ ...btnPrimary(), padding: "12px 50px" }}
              >
                Book
              </button>
            </div>
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 40, padding: "20px 40px" }}>
        ...
        >
          ...
          <div style={{ color: COLORS.gray, marginBottom: 10 }}>
            {d.specialty}
          </div>
          <div
            style={{
          ...
          >
            <div>
              {d.consultationFee}-{d.consultationFee + 150} $
            </div>
            <div>Online / Offline</div>
            <div>
              <CreditCard size={14} style={{ verticalAlign: -2 }} /> Price :{" "}
              {d.price}
            </div>
            <div style={{ color: COLORS.green }}>
              <Clock size={14} style={{ verticalAlign: -2 }} /> Waiting Time :{" "}
              {d.waiting} Minutes
            </div>
            <div>
              <Phone size={14} style={{ verticalAlign: -2 }} /> 1599 : Cost of
              regular call
            </div>
          </div>
          <button
            onClick={() => go("bookAppointment", d)}
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ color: COLORS.gray, marginBottom: 16 }}>
            {d.specialty}
          </div>
          <div
            style={{
          ...
          >
            <MapPin size={18} /> {d.area}, Egypt
          </div>
          <p style={{ color: COLORS.gray, lineHeight: 1.7, maxWidth: 600 }}>
            {d.bio}
          </p>
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 40, padding: "20px 40px" }}>
        ...
        <div style={{ flex: 1, maxWidth: 700 }}>
          ...
          <p style={{ color: COLORS.gray, margin: "10px 0 24px" }}>
            You will be contacted by phone number by the doctor's clinic to
          ...
          >
            ...
            <span style={{ color: COLORS.main, cursor: "pointer" }}>
              April <ChevronRight size={14} style={{ verticalAlign: -2 }} />
            </span>
          </div>
          <div style={{ display: "flex", gap: 10, marginBottom: 24 }}>
            {dates.map((dt) => (
              <div
                ...
                style={{
                  ...
                  textAlign: "center",
                  fontSize: 14,
                  background: date === dt ? COLORS.main : "#fff",
                  color: date === dt ? "#fff" : COLORS.text,
          ...
          <div style={{ display: "flex", gap: 14, marginBottom: 24 }}>
            {times.map((t) => (
              <button
                ...
                onClick={() => setTime(t)}
                style={
                  time === t ? btnPrimary({ flex: 1 }) : btnOutline({ flex: 1 })
                }
              >
                {t}
              </button>
          ...
          >
            ...
            />
            Attach files (Max. 10 files)
          </div>

          <button
            onClick={() => go("bookingConfirmed", d)}
            style={{
              ...btnPrimary(),
              width: "100%",
              padding: 16,
      ...
      <div style={{ display: "flex", gap: 40, padding: "20px 40px" }}>
        ...
        >
          ...
          <div style={{ padding: 24 }}>
            <div style={{ display: "flex", gap: 10, marginBottom: 14 }}>
              ...
              <span>We notified {d.name} of your booking</span>
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <span>Examination Fees: {d.consultationFee} EGP</span>
            </div>
            <div style={{ display: "flex", gap: 10, marginBottom: 8 }}>
              <Phone size={18} color={COLORS.gray} />
              <span>
                Clinic number:{" "}
                <span style={{ color: COLORS.main }}>01000722584</span>
              </span>
            </div>
            <div
              style={{
            ...
            >
              ...
              <strong>{PATIENT_PROFILE.name}</strong>
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <strong>{d.clinicLocation[0]}</strong>
            </div>
            <button
              onClick={() => go("patientPortal", { tab: "appointments" })}
        ...
        >
          ...
          <div style={{ padding: 24 }}>
            ...
            <p style={{ color: COLORS.gray, fontSize: 13, marginBottom: 10 }}>
              Use images or PDF files (Max. 10 files)
            </p>
            <div
              style={{
                border: "1px dashed #ccc",
      ...
      <div style={{ flex: 1, padding: "60px 70px" }}>
          ...
          {["login", "signup"].map((t) => (
            <div
              ...
              style={{
                ...
                fontSize: 22,
                fontWeight: 700,
                color: tab === t ? COLORS.main : "#ccc",
                borderBottom: tab === t ? `3px solid ${COLORS.main}` : "none",
              }}
            >
        ...
        {tab === "login" ? (
          <>
            ...
            <button
              onClick={() =>
                setRole(regRole === "doctor" ? "doctor" : "patient")
              }
  ...
  return (
    <div style={{ textAlign: "center", padding: "100px 40px" }}>
      ...
      <p style={{ color: COLORS.gray, maxWidth: 460, margin: "0 auto 30px" }}>
        An admin will review your documents and approve your account. You'll be
        notified once you can log in.
      </p>
      <button onClick={() => go("landing")} style={btnPrimary()}>
        Back to home
      </button>
    </div>
  );
      ...
      {items.map((it) => (
        <div
          ...
          style={{
            ...
            borderRadius: 8,
            cursor: "pointer",
            background: active === it.key ? "#eef0f0" : "transparent",
            color: COLORS.text,
            marginBottom: 4,
            textAlign: "left",
          }}
...
function PatientProfileTab() {
  return (
    <div style={{ maxWidth: 600 }}>
      ...
      <input
        defaultValue={PATIENT_PROFILE.email}
        style={{ ...inputStyle(), marginBottom: 18 }}
      />
      <label style={label()}>Location</label>
      <input
        defaultValue={PATIENT_PROFILE.location}
        style={{ ...inputStyle(), marginBottom: 18 }}
      />
      <label style={label()}>Phone Number</label>
      <input
        defaultValue={PATIENT_PROFILE.phone}
        style={{ ...inputStyle(), marginBottom: 18 }}
      />
      <label style={label()}>National ID</label>
      <input
        defaultValue={PATIENT_PROFILE.nationalId}
  ...
  return (
    <div style={{ maxWidth: 600 }}>
      <h2 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>
        ID Search emergency info
      </h2>
      <p style={{ color: COLORS.gray, marginBottom: 24, fontSize: 14 }}>
        This is the information shown to anyone who searches your National ID in
        an emergency.
      </p>
      ...
      <input
        defaultValue={PATIENT_PROFILE.emergencyPhone}
        style={{ ...inputStyle(), marginBottom: 18 }}
      />
      ...
      <select
        defaultValue={PATIENT_PROFILE.bloodType}
        style={{ ...inputStyle(), marginBottom: 18 }}
      >
      ...
      <textarea
        defaultValue={PATIENT_PROFILE.chronic}
        style={{ ...inputStyle(), marginBottom: 18, minHeight: 70 }}
      />
      <label style={label()}>Allergies</label>
      <input
        defaultValue={PATIENT_PROFILE.allergies}
        style={{ ...inputStyle(), marginBottom: 26 }}
      />
          ...
          {["Pending", "Approved", "Completed", "Cancelled"].map((s) => (
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: "pointer",
                border: `1.5px solid ${statusColor(s).text}`,
                background: filter === s ? statusColor(s).text : "#fff",
                color: filter === s ? "#fff" : statusColor(s).text,
              }}
            >
              {s}
            </button>
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 24 }}>
        ...
        <button style={{ ...btnOutline({ borderRadius: 10 }) }}>
        ...
        {HISTORY_FOLDERS[active].entries.map((e, i) => (
          <div
            ...
            style={{
              ...
              paddingBottom: 24,
              borderBottom:
                i < HISTORY_FOLDERS[active].entries.length - 1
                  ? "1px dashed #ddd"
                  : "none",
            }}
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <div>
                <div
                  style={{ color: COLORS.gray, fontSize: 13, marginBottom: 4 }}
                >
                  {e.date}
                </div>
                ...
                <div style={{ fontSize: 14, marginBottom: 4 }}>
                  Treating Physician : {e.physician}
                </div>
                <div
                  style={{ fontSize: 13, color: COLORS.gray, marginBottom: 10 }}
                >
                  {e.visitDate}
                </div>
                <div
                  style={{ fontSize: 14, color: COLORS.text, maxWidth: 540 }}
                >
                  Note : {e.note}
                </div>
              </div>
              ...
              >
                <button
                  style={btnOutline({ fontSize: 13, padding: "8px 16px" })}
                >
                  View documents
                </button>
...
function PatientDoctorAccessTab() {
  return (
    <div>
      ...
      <p style={{ color: COLORS.gray, marginBottom: 24, fontSize: 14 }}>
        Grant doctors permission to view or edit specific medical history
        folders.
      </p>
    ...
    <div>
      ...
      >
          ...
          {CHATS.map((c, i) => (
            <div
              ...
              style={{
                ...
                padding: 14,
                cursor: "pointer",
                background: active === i ? "#e9f7f8" : "transparent",
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          >
            <img
              src={CHATS[active].img}
              alt={CHATS[active].name}
              style={{
                width: 36,
                height: 36,
                borderRadius: "50%",
      ...
      >
        {DOCTOR_TODAY.map((a, i) => (
          <div
            key={i}
            style={{
              background: i === 0 ? COLORS.main : "#fff",
              color: i === 0 ? "#fff" : COLORS.text,
              border: i === 0 ? "none" : `1px solid ${COLORS.main}`,
              borderRadius: 12,
              padding: 16,
              minWidth: 200,
              display: "flex",
            ...
            {requests.map((r, i) => (
              <tr key={i} style={{ borderBottom: "1px solid #eee" }}>
                ...
                <td style={{ padding: "12px 14px" }}>
                  {r.location},{" "}
                  <span
                    style={{ color: COLORS.main, textDecoration: "underline" }}
                  >
                    See location
                  </span>
                </td>
                <td style={{ padding: "12px 14px" }}>
                  <button
                    onClick={() =>
                      setRequests(requests.filter((_, idx) => idx !== i))
                    }
                    style={{
                      background: "#eaf6ec",
                      border: "none",
          ...
          {APPOINTMENTS.map((a, i) => (
            <tr key={i} style={{ borderBottom: "1px solid #eee" }}>
              ...
              <td style={{ padding: "12px 14px" }}>
                {a.status === "Approved" ? (
                  <button
                    style={btnOutline({ padding: "6px 14px", fontSize: 13 })}
                  >
                    Complete
                  </button>
                ) : (
...
function DoctorSlotsTab() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>
        Free Appointments This Week
      </h2>
      <p style={{ color: COLORS.gray, fontSize: 14, marginBottom: 24 }}>
        Each slot is 30 minutes and can only be booked by one patient.
      </p>
      <div
        style={{
          display: "flex",
      ...
      >
        {dates.map((d) => (
          <div
            key={d}
            onClick={() => toggle(d, selectedDates, setSelectedDates)}
            style={{
              cursor: "pointer",
              padding: "10px 14px",
              borderRadius: 10,
              ...
              fontSize: 14,
              minWidth: 56,
              background: selectedDates.includes(d) ? COLORS.main : "#fff",
              color: selectedDates.includes(d) ? "#fff" : COLORS.text,
      ...
      >
        {times.map((t, i) => (
          <div
            key={i}
            onClick={() => toggle(t, selectedTimes, setSelectedTimes)}
            style={{
              cursor: "pointer",
              padding: "10px 8px",
              borderRadius: 10,
              textAlign: "center",
              fontSize: 13,
              background: selectedTimes.includes(t) ? COLORS.main : "#fff",
              color: selectedTimes.includes(t) ? "#fff" : COLORS.text,
...
function DoctorUpdateProfileTab() {
  return (
    <div style={{ maxWidth: 600 }}>
      ...
      <input
        defaultValue="Nasr City Medical Center, Building 5"
        style={{ ...inputStyle(), marginBottom: 18 }}
      />
      ...
      <textarea
        defaultValue="Experienced cardiologist with 10+ years treating heart diseases."
        style={{ ...inputStyle(), marginBottom: 18, minHeight: 70 }}
      />
      ...
      <textarea
        defaultValue={
          "MBBS, Cairo University, 2012\nMD Cardiology, Ain Shams University, 2017"
        }
        style={{ ...inputStyle(), marginBottom: 18, minHeight: 70 }}
      />
      <label style={label()}>Certifications</label>
      <textarea
        defaultValue="Advanced Cardiac Life Support — AHA, 2020"
        style={{ ...inputStyle(), marginBottom: 26, minHeight: 60 }}
      />
      <button style={btnPrimary()}>Save</button>
    </div>
  );
...
function DoctorPatientAccessTab() {
  return (
    <div>
      <h2 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>
        Patient records you can access
      </h2>
      <p style={{ color: COLORS.gray, marginBottom: 24, fontSize: 14 }}>
        You can only see folders the patient has explicitly granted you access
        to.
      </p>
      <div
        style={{
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ color: COLORS.gray, fontSize: 13 }}>
              Folder: Cardiology · Permissions: View, Add
            </div>
          </div>
        ...
        >
          <strong>Mild Arrhythmia</strong> — 2/4/2025
          <br />
          <span style={{ color: COLORS.gray }}>
            Patient reports occasional palpitations. ECG shows mild
            irregularity.
          </span>
        </div>
      </div>
      ...
      <div style={{ flex: 1 }}>
        ...
        {tab === "profile" && (
          <div style={{ maxWidth: 600 }}>
            ...
            <p style={{ color: COLORS.gray, marginBottom: 18 }}>
              This is how patients see you when booking.
            </p>
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 13 }}>
          Nasr City Medical Center, Building 5 · 300 EGP
        </div>
      </div>
    </div>
  );
      ...
      {items.map((it) => (
        <div
          ...
          style={{
            ...
            padding: "12px 24px",
            cursor: "pointer",
            background: active === it.key ? COLORS.main : "transparent",
            color: active === it.key ? "#fff" : COLORS.text,
          }}
        >
          <it.icon size={18} /> {it.label}
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        >
          <User size={18} color={COLORS.main} />
        </div>
        <strong>Admin</strong>
      </div>
    </div>
...
function AdminDashboardTab() {
  const stats = [
    ...
    },
    {
      label: "Hospitals",
      value: 245,
      sub: "3 Hospitals Join This week",
      icon: Building2,
      color: "#cb2027",
    },
    {
    ...
    <div style={{ padding: 30 }}>
      ...
      >
        {stats.map((s) => (
          <div
            key={s.label}
            style={{ border: "1px solid #eee", borderRadius: 14, padding: 20 }}
          >
            <div
              style={{
                width: 44,
      ...
      >
        ...
        >
          ...
          {["Gynecology", "Cardiology", "Orthopedics", "Dermatology"].map(
            (s) => (
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ color: COLORS.gray, fontSize: 13 }}>
              {["Patient", "Date & Time", "Doctor", "Type", "Status"].map(
                (h) => (
...
function AdminDoctorRequestsTab() {
  ...
  return (
    <div style={{ padding: 30 }}>
      ...
      <p style={{ color: COLORS.gray, marginBottom: 24, fontSize: 14 }}>
        Review submitted documents before approving access to the system.
      </p>
      {reqs.length === 0 && (
        <div style={{ color: COLORS.gray, padding: 30, textAlign: "center" }}>
          No pending requests.
        </div>
      )}
      {reqs.map((r, i) => (
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ color: COLORS.gray, fontSize: 13 }}>
                {r.specialty} · Submitted {r.date}
              </div>
            </div>
            <div style={{ display: "flex", gap: 10 }}>
              <button
                onClick={() => setReqs(reqs.filter((_, idx) => idx !== i))}
                style={{
                  ...btnPrimary({
      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        <thead>
          <tr style={{ color: COLORS.gray, fontSize: 13, textAlign: "left" }}>
            {["No.", "Name", "Specialization", "Status", "Action"].map((h) => (
              <th key={h} style={{ padding: "10px 0" }}>
                {h}
              </th>
            ))}
          </tr>
          ...
          {DOCTORS.map((d, i) => (
            <tr key={d.id} style={{ borderTop: "1px solid #f0f0f0" }}>
              ...
              <td style={{ padding: "12px 0" }}>
                <span
                  style={{
                    color: d.status === "approved" ? COLORS.green : "#cc9a06",
                    fontWeight: 600,
                    fontSize: 13,
                  }}
                >
        ...
        <tbody>
          {APPOINTMENTS.map((a, i) => (
            <tr key={i} style={{ borderTop: "1px solid #f0f0f0" }}>
              ...
              <td style={{ padding: "12px 0" }}>
                <span
                  style={{ color: statusColor(a.status).text, fontWeight: 600 }}
                >
                  {a.status}
                </span>
              </td>
...
export default function App() {
      ...
      {["patient", "doctor", "admin"].map((r) => (
        <button
          ...
          style={{
            ...
            border: role === r ? "none" : "1px solid #ddd",
            background: role === r ? COLORS.main : "#fff",
  ...
  let content;
  if (page === "patientPortal")
    content = <PatientPortal go={go} ctx={ctx} exitRole={exitRole} />;
  else if (page === "doctorPortal")
    content = <DoctorPortal ctx={ctx} exitRole={exitRole} />;
  else if (page === "adminPortal")
    content = <AdminPortal exitRole={exitRole} />;
  else {
    content = (
      <div
        style={{
      ...
      >
        ...
        {page === "doctorProfilePublic" && (
          <DoctorProfilePublic go={go} ctx={ctx} />
        )}
        {page === "bookAppointment" && <BookAppointment go={go} ctx={ctx} />}
        {page === "bookingConfirmed" && <BookingConfirmed go={go} ctx={ctx} />}
        {page === "login" && (
          <AuthPage go={go} mode="login" setRole={handleSetRole} />
        )}
        {page === "signup" && (
          <AuthPage go={go} mode="signup" setRole={handleSetRole} />
        )}
